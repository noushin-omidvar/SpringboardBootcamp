...
SELECT app_name, price, rating FROM analytics WHERE price between 0.1 AND 1 AND rating IS NOT NULL ORDER BY rating DESC LIMIT 10;
...
SELECT app_name, ARRAY_LENGTH(genres, 1) AS array_length FROM analytics WHERE ARRAY_LENGTH(genres, 1) > 1;
